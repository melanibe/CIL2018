...
from model.model9_ls import Discriminator
from config import *
import pandas as pd
...
tf.flags.DEFINE_integer("out_channels1", 16, "out_channels1")
tf.flags.DEFINE_integer("out_channels2", 8, "out_channels2")

# Training parameters
tf.flags.DEFINE_integer("batch_size", 64, "Batch Size (default: 64)")
tf.flags.DEFINE_integer("num_epochs_label", 100, "Number of training epochs (default: 200)")
tf.flags.DEFINE_integer("num_epochs_score", 100, "Number of training epochs (default: 200)")
